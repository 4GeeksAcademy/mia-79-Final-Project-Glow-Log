...
export default function EditProduct() {
    ...
    useEffect(() => {
        const targetID = params.purchaseDetailID
        const purchaseDetail = store.products.find((purchase) => purchase.id == targetID)
        if (!purchaseDetail) return
        setProductName(purchaseDetail.product.name);
        setPurchasePrice(purchaseDetail.price);
        setPurchasePriceDisplay(formatCurrency(purchaseDetail.price.toString()))
        setCategory(purchaseDetail.product.type);
        setPurchaseDate(parseDate(purchaseDetail.purchase_date));
        setExpirationDate(parseDate(purchaseDetail.expiration_date));
        setBrand(purchaseDetail.product.brand);
    }, [])
    return (
        <div
